from provider_estimator import ProviderEstimator
from network_connection import NetworkConnection
from task import Task
from task_info import FailedByProvider, TaskStatusPayload, TaskStatus, TaskResult
from util.logger import logger
from meta_info import PublicMetaInfo, PrivateMetaInfo
...
class Provider:
    ...
    def schedule_task(self, task: Task):
        ...
        # TODO
        # await self.async_schedule_task(task)
